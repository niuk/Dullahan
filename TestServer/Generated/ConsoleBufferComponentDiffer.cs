...
namespace TestGame {
    partial class World {
        partial class Entity {
            partial class ConsoleBufferComponent {
                public class Differ : IDiffer<(ConsoleBufferComponent, int)> {
                    public bool Diff((ConsoleBufferComponent, int) componentAtOldTick, (ConsoleBufferComponent, int) componentAtNewTick, BinaryWriter writer) {
                        ...
                        /* consoleBuffer */ {
                            int snapshotIndex = component.consoleBuffer_ticks.BinarySearch(newTick);
                            if (snapshotIndex < 0) {
                            ...
                            int snapshotTick = component.consoleBuffer_ticks[snapshotIndex];
                            int diffTick = snapshotTick - oldTick;
                            if (diffTick > 0) {
                                var snapshot = component.consoleBuffer_snapshots[snapshotIndex];
                    ...
                    public void Patch(ref (ConsoleBufferComponent, int) componentAtTick, BinaryReader reader) {
                        ...
                        if ((dirtyFlags >> 0 & 1) != 0) {
                            var value = component.consoleBuffer;
                            Snapshot_consoleBuffer.differ.Patch(ref value, reader);
                            component.consoleBuffer = value;
                        }
